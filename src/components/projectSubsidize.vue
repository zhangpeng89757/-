    ...
    <div style="width: 100%;height: 100%" >
      ...
      >
        ...
        <Vue3SeamlessScroll id="box" :list="scrollList" class="seamless-warp scroll" :hover="true" :step="0.3">
          <el-table :height="tableHeight" :data="scrollList" :cell-style="{ textAlign: 'center',color:'#ffffff',border:0}" :header-cell-style="{textAlign: 'center',backgroundColor: '#051e46',border:0}" :show-header="false" stripe>
            <el-table-column id="_1" prop="year" show-overflow-tooltip/>
...
onUpdated(()=>{
  // const Height= document.getElementById('_1');
